...
export default function PlasticsurgPage() {
  useEffect(() => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">OPD ศัลย์ตกแต่ง</h1>
      <p>หน้าสำหรับแสดงข้อมูลผู้ป่วยที่ส่งมายัง OPD ศัลย์ตกแต่ง</p>
    </div>
  )
}
